...
async def aqua(ctx: commands.Context):
      ...
      try:
        ...
        dj = f'AutoDJ{j["live"]["streamer_name"]}'.replace(f'AutoDJ ', 'AutoDJ')
        ...
        embed.add_field(name="> DJ", value=f'{dj}'.replace(f'AutoDJ{j["live"]["streamer_name"]}', f'{j["live"]["streamer_name"]}'), inline=False)
